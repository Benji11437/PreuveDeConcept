...
Cette application permet de prédire automatiquement le sentiment
des tweets en temps réel à l’aide d’un modèle de traitement du langage naturel.
</p>
...
Cette interface respecte plusieurs recommandations des **WCAG 2.2 – niveau AA** :
